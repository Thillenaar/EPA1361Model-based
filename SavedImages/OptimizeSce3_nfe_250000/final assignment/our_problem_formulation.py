...
def get_model_for_problem_formulation():
    ...
    model.outcomes = [
        ScalarOutcome(
            "A1_Expected_Annual_Damage",
            variable_name="A.1_Expected Annual Damage",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
            "A1_Dike_Investment_Costs",
            variable_name="A.1_Dike Investment Costs",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
        ...
        ScalarOutcome(
            "A2_Expected_Annual_Damage",
            variable_name="A.2_Expected Annual Damage",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
            "A2_Dike_Investment_Costs",
            variable_name="A.2_Dike Investment Costs",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
        ...
        ScalarOutcome(
            "A3_Expected_Annual_Damage",
            variable_name="A.3_Expected Annual Damage",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
            "A3_Dike_Investment_Costs",
        ...
        ScalarOutcome(
            "A4_Expected_Annual_Damage",
            variable_name="A.4_Expected Annual Damage",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
            "A4_Dike_Investment_Costs",
            variable_name="A.4_Dike Investment Costs",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
        ...
        ScalarOutcome(
            "A5_Expected_Annual_Damage",
            variable_name="A.5_Expected Annual Damage",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
            "A5_Dike_Investment_Costs",
            variable_name="A.5_Dike Investment Costs",
            function=sum_over,
            kind=direction,
        ),
        ScalarOutcome(
